...
MyTheme.register(function(app, auth, database, system) {
  ...
  MyTheme.menus.add({
    ...
    menu: 'mymain' //was 'main'
  });
  

  //Set views path, template engine and default layout -- this is from system package, overriding what system does
  app.set('views', __dirname + '/server/views'); //this is what express loads up - express is the entry point to your app
